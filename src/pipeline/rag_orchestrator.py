...
class RAGPipeline:
    ...
    def __init__(
        ...
        Args:
            ...
            generator_llm: The main LLM (e.g., 1.5B/3B) for drafting the final answer.
        """
    ...
    def run(self, raw_query: str) -> str:
        ...
        """
        print("\n" + "="*60)
        print(f"🚀 INITIATING RAG PIPELINE")
        ...
        # Rerank and keep only the absolute best (e.g., top 5) for the LLM context
